...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupControls() {
        ...
        upButton!!.setOnClickListener { game!!.fallingSquare!!.ApplyForce(Vector(0f, -100f)) }
    ...
    inner class Game : GameObject() {
        ...
        override fun onStart(surface: GameSurface?) {
            ...
            fallingSquare = DroppingRectangle(
                position = Vector((surface.width / 3).toFloat(), (surface.height / 3).toFloat()),
                width = 100f,
                height = 100f,
                color = Color.GREEN,
                mass = 1f,
            ...
            surface.addGameObject(fallingSquare!!)

//            surface.addGameObject(
//                DroppingRectangle(
//                    Vector((surface.width / 4).toFloat(),(surface.height / 3).toFloat()),
//                    1f, 100f, 100f, 1f,
//                    Color.rgb(128, 14, 80)
//                )
//            )
        ...
        var fallingSquare: DroppingRectangle? = null
